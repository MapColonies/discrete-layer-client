...
const POLYGONPARTS = (window as any)._env_.POLYGONPARTS;
...
const APP_CONFIG = {
  ...
  BFF_PATH: BFF_PATH,
  POLYGON_PARTS: {
    FEATURE_TYPE_PREFIX: POLYGONPARTS.featureTypePrefix,
    MAX: {
      PER_SHAPE: POLYGONPARTS.MAX.perShape,
      VERTICES: POLYGONPARTS.MAX.vertices,
    }
  }
};
