...
const APP_CONFIG = {
  ...
  ACCESS_TOKEN: {
    ATTRIBUTE_NAME: 'x-api-key',
    INJECTION_TYPE: "header",
    TOKEN_VALUE: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwicmVzb3VyY2VUeXBlcyI6WyJyYXN0ZXIiLCJkZW0iLCJ2ZWN0b3IiLCIzZCJdLCJpYXQiOjE1MTYyMzkwMjJ9.kidhXiB3ihor7FfkaduJxpJQXFMJGVH9fH7WI6GLGM0"
  },
