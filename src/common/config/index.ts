...
const ANALYZER_ROUTE = (window as any)._env_.ANALYZER_ROUTE;
const ANALYZER_TOKEN_VALUE = (window as any)._env_.ANALYZER_TOKEN_VALUE;
...
const APP_CONFIG = {
  ...
  ANALYZER_TOKEN_VALUE: ANALYZER_TOKEN_VALUE,
  RUNNING_MODE: {
