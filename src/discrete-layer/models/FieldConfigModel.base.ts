...
export const fieldConfigModelPrimitives = selectFromFieldConfig().fieldName.label.fullWidth.isManuallyEditable.isFilterable.isSortable.isRequired.isAutoGenerated.isCreationEssential.infoMsgCode.default.autocomplete(autocompletionModelPrimitives).validation(validationConfigModelPrimitives)
