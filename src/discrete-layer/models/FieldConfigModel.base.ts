...
import { AutocompletionModelSelector } from "./AutocompletionModel.base"
...
import { ValidationConfigModelSelector } from "./ValidationConfigModel.base"
...
export const fieldConfigModelPrimitives = selectFromFieldConfig().fieldName.label.fullWidth.isManuallyEditable.isFilterable.isSortable.isRequired.isAutoGenerated.isLifecycleEnvolved.isCopyable.rows.infoMsgCode.default.dateGranularity.lookupTable
