...
export const fieldConfigModelPrimitives = selectFromFieldConfig().fieldName.label.fullWidth.isManuallyEditable.isFilterable.isSortable.isRequired.isAutoGenerated.infoMsgCode.autocomplete(autocompletionModelPrimitives).validation(validationConfigModelPrimitives)
