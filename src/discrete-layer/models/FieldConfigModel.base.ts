...
export const fieldConfigModelPrimitives = selectFromFieldConfig().fieldName.label.fullWidth.isManuallyEditable.isSortable.isRequired.isAutoGenerated.isLifecycleEnvolved.isCopyable.rows.infoMsgCode.default.dateGranularity.autocomplete(autocompletionModelPrimitives).validation(validationConfigModelPrimitives).isFilterable(filterableFieldConfigModelPrimitives).lookupTable.lookupExcludeFields
