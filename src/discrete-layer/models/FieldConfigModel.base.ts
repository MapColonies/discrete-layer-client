...
export const FieldConfigModelBase = withTypedRefs<Refs>()(ModelBase
  ...
  .props({
    ...
    shapeFileMapping: types.union(types.undefined, types.null, types.string),
  })
  .views(self => ({
    get store() {
...
export class FieldConfigModelSelector extends QueryBuilder {
  ...
  get shapeFileMapping() { return this.__attr(`shapeFileMapping`) }
