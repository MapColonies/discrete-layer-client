...
const ROLES: IRole[] = [
  {
    ...
    permissions: {
      ...
      'entity_action.LayerRasterRecord.flyTo': true,
      'entity_action.Layer3DRecord.flyTo': true,
  ...
  },
  {
    ...
    permissions: {
      ...
      'entity_action.LayerRasterRecord.flyTo': false,
      'entity_action.Layer3DRecord.flyTo': false,
      'entity_action.LayerRasterRecord.update': false,
