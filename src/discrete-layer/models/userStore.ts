...
const ROLES: IRole[] = [
  {
    ...
    permissions: {
      ...
      [UserAction.ENTITY_ACTION_LAYER3DRECORD_EXPORT]: true,
      [UserAction.ENTITY_ACTION_LAYERDEMRECORD_EXPORT]: true,
      [UserAction.ENTITY_ACTION_BESTRECORD_EXPORT]: true,
      [UserAction.ENTITY_ACTION_VECTORBESTRECORD_EXPORT]: true,
