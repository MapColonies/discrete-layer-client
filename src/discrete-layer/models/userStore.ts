...
export enum UserAction {
  ...
  ENTITY_ACTION_LAYERRASTERRECORD_SAVE_METADATA = 'entity_action.LayerRasterRecord.save-metadata',
  ENTITY_ACTION_LAYER3DRECORD_CREATE = 'entity_action.Layer3DRecord.create',
  ENTITY_ACTION_LAYER3DRECORD_SAVE_METADATA = 'entity_action.Layer3DRecord.save-metadata',
  ENTITY_ACTION_LAYERDEMRECORD_CREATE = 'entity_action.LayerDemRecord.create',
  ENTITY_ACTION_LAYERDEMRECORD_SAVE_METADATA = 'entity_action.LayerDemRecord.save-metadata',
  ENTITY_ACTION_BESTRECORD_CREATE = 'entity_action.BestRecord.create',
  ENTITY_ACTION_BESTRECORD_SAVE_METADATA = 'entity_action.BestRecord.save-metadata',
  ...
  ENTITY_ACTION_VECTORBESTRECORD_SAVE_METADATA = 'entity_action.VectorBestRecord.save-metadata',
  ...
  ENTITY_ACTION_LAYER3DRECORD_UNPUBLISH = 'entity_action.Layer3DRecord.unpublish',
...
const ROLES: IRole[] = [
  {
    ...
    permissions: {
      ...
      [UserAction.ENTITY_ACTION_LAYERRASTERRECORD_SAVE_METADATA]: true,
      [UserAction.ENTITY_ACTION_BESTRECORD_SAVE_METADATA]: true,
      [UserAction.ENTITY_ACTION_LAYER3DRECORD_SAVE_METADATA]: true,
      [UserAction.ENTITY_ACTION_LAYERDEMRECORD_SAVE_METADATA]: true,
      [UserAction.ENTITY_ACTION_BESTRECORD_SAVE_METADATA]: true,
      [UserAction.ENTITY_ACTION_VECTORBESTRECORD_SAVE_METADATA]: true,
      ...
      [UserAction.ENTITY_ACTION_LAYER3DRECORD_UNPUBLISH]: true,
  ...
  },
  {
    ...
    permissions: {
      ...
      [UserAction.ENTITY_ACTION_LAYER3DRECORD_UNPUBLISH]: false,
      [UserAction.ENTITY_ACTION_LAYERRASTERRECORD_FLYTO]: true,
      [UserAction.ENTITY_ACTION_LAYER3DRECORD_FLYTO]: true,
