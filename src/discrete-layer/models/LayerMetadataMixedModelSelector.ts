...
export type LayerMetadataMixedUnion = Layer3DRecordModelType | LayerRasterRecordModelType | BestRecordModelType
...
export const layerMetadataMixedModelPrimitives = selectFromLayerMetadataMixed().layer3DRecord(layer3DRecordModelPrimitives).layerRasterRecord(layerRasterRecordModelPrimitives).bestRecord(bestRecordModelPrimitives)