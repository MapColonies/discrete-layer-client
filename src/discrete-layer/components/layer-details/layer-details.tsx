...
export const LayersDetailsComponent: React.FC<LayersDetailsComponentProps> = (props: LayersDetailsComponentProps) => {
  ...
  // @ts-ignore
  const MemoizedInputs = (category: IRecordCategoryFieldsInfo) => (useMemo((): any => {
    return (category as IRecordCategoryFieldsInfo)?.fields?.map((fieldInfo: IRecordFieldInfo) => {
        ...
        return (
          ...
          >
            <FieldLabelComponent 
              ...
              {
                getValuePresentor(layerRecord as LayerMetadataMixedUnion, fieldInfo, get(layerRecord, fieldInfo.fieldName as string), mode, formik)
              }
          </Box>
        );
      }
