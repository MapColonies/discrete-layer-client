...
export const EntityDialogComponent: React.FC<EntityDialogComponentProps> = observer((props: EntityDialogComponentProps) => {
  ...
  [
    { fieldName: 'directory', label: 'field-names.ingestion.directory', isRequired: true, isAutoGenerated: false }, 
    { fieldName: 'fileNames', label: 'field-names.3d.fileNames', isRequired: true, isAutoGenerated: false },
    ...descriptors
  ].forEach(field => {
