...
export const EntityDialogComponent: React.FC<EntityDialogComponentProps> = observer((props: EntityDialogComponentProps) => {
  ...
  const ingestionFields = [
    { fieldName: 'directory', label: 'field-names.ingestion.directory', isRequired: true, isAutoGenerated: false, value: directory },
    { fieldName: 'fileNames', label: recordType === RecordType.RECORD_3D ? 'field-names.3d.fileNames' : 'field-names.raster.fileNames', isRequired: true, isAutoGenerated: false, value: fileNames }
  ];
      ...
      <Dialog open={isOpen} preventOutsideDismiss={true}>
        ...
        <DialogContent className="dialogBody">
          <form onSubmit={formik.handleSubmit} className="form">
            {
              mode === Mode.NEW && <IngestionFields fields={ingestionFields} formik={formik}/>
            }
